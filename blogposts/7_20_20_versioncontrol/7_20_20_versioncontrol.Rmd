...
Most of the time I spray these text files with words, and then make a commit after an hour or two. More recently, I'm trying to make commits that reflect sections of content in my writing. For example, when I feel like I did something coherent and identifiable, I make a commit and give it a label. I assume these labels could be useful later on if I ever want to take a look at "my process". But, I haven't spent too much time doing that. Even this foray into a meta-level discourse on my own blog is relatively new to me. I should probably be researching eugenics right now. Instead, what is this that I'm doing?
