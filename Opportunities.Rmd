...
Students interested in pursuing a Ph.D. should apply to the [Cognitive and Comparative Psychology (CCP) training area](https://ccp-cuny.github.io) in the Psychology Doctoral Program at the Graduate Center of CUNY. The deadline for applications December 1st, 2019. [You can apply directly here](http://www.gc.cuny.edu/Prospective-Current-Students/Prospective-Students/Admissions). Interested applicants should also email Matt Crump (mcrump@brooklyn.cuny.edu) to introduce themselves and their research interests.
