---
title: "Unplanning my next course prep"
description: "Sunday morning thoughts on not overplanning while prepping a new course."
author: "Matt Crump"
date: '2022-10-16'
image: 'images/unplanning.jpg'
opengraph:
  twitter:
...
#| echo: FALSE
#| out.width: 100%
knitr::include_graphics('images/unplanning.jpg')
```
...
What does unplanning entail? I'm not so sure yet, so I'm slopping down thoughts about what I might mean. Relatedly, this Fall 2022 semester I am trying "ungrading" [@blum2020] in my [intro to cognition course](https://crumplab.com/cognition). This approach can mean lots of different things for a classroom, and [I've been blogging a bit about that over here](https://crumplab.com/blog/post_888_8_23_22_teaching2530/). One of the things it means to me is that the class becomes a community space inhabited by participating individual learners. From this vantage point, I've been working through what it means to deliver my planned course as a member of the community who is very quickly coming up to speed with community wants and needs.
