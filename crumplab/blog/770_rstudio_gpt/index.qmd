...
FYI: I'm live-blogging this today, and will be actively updating this post for the afternoon.
...
The first function I wrote is a basic line editor. I wanted to be able to highlight selected text in RStudio, then quickly send it to an LLM with a request to edit the text for clarity, flow, and length.
