...
A bunch of #rstats people I follow were migrating over to Mastodon, so I went along too and started an account on Fosstodon <https://fosstodon.org/@MattCrumpLab>. Mastodon had popped up here and there for me before, but I had never tried it out. [Fosstodon](https://fosstodon.org/about/more) is a mastodon instance with lots of people interested in free and open-source software. I'm a big admirer, user, and supporter of open-source stuff, so wonderful, I joined. 
