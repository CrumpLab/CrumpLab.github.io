...
::: columns
::: {.column width="70%"}
## [MCHC 1002 Seminar 2: People of New York City](https://crumplab.github.io/peopleofnyc/)

Brooklyn College of CUNY, Undergraduate, Macaulay Honors Seminar 2

:::

::: {.column width="30%"}
<a href="https://crumplab.github.io/peopleofnyc/">

```{r peopleNYC, out.width=150, echo=F}
knitr::include_graphics("images/peopleNYC.jpg")
```
...
::: columns
::: {.column width="70%"}
## [Psyc 3470/SOCY 3507 Data Analytics and Data Visualization in the Social and Behavioral Sciences](https://crumplab.github.io/psyc3470)
...
::: {.column width="30%"}
<a href="https://crumplab.github.io/psyc3470">

```{r psyc3470, out.width=150, echo=F}
knitr::include_graphics("images/ads.png")
```
...
::: columns
::: {.column width="70%"}
## [Psyc 2530 Introduction to Cognitive Psychology](https://crumplab.github.io/cognition/)
...
```{r 2530_Fall_2022, out.width=150, echo=F}
...
Spring 2022, Brooklyn College of CUNY, Undergraduate, Psychology, Asynchronous online
...
Spring 2022, Brooklyn College of CUNY, Experimental Psychology MA program

[Course website](https://crumplab.github.io/rstatsmethods/) contains syllabus and readings.
:::
...
2020-2021, Brooklyn College of CUNY, Master's, Experimental Psychology
...
2020, 2021, Graduate Center of CUNY, Doctoral, Cognitive and Comparative Psychology Training (CCP) area
