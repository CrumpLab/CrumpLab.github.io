...
image_link("images/front/people-logos_black.png","https://www.crumplab.com/People.html")
```
...
```{r}
image_link("images/front/publications-logos_black.png","https://www.crumplab.com/Publications.html")
```
...
```{r}
image_link("images/front/books.png","https://www.crumplab.com/Books.html")
```
...
```{r}
image_link("images/front/courses.png","https://www.crumplab.com/Courses.html")
```
...
```{r}
image_link("images/front/apps.png","https://www.crumplab.com/Apps.html")
```
...
```{r}
image_link("images/front/join.png","https://www.crumplab.com/Opportunities.html")
```
...
```{r}
image_link("images/front/contact-logos_black.png","https://www.crumplab.com/index.html#contact")
```
