...
output: 
  github_document:
    includes:
      in_header: [web/header_index.html]
---
...
image_link("man/figures/front/people-logos_black.png","https://www.crumplab.com/People.html", class = "hovericon")
```
...
```{r}
image_link("man/figures/front/publications-logos_black.png","https://www.crumplab.com/Publications.html", class = "hovericon")
```
...
```{r}
image_link("man/figures/front/books.png","https://www.crumplab.com/Books.html", class = "hovericon")
```
...
```{r}
image_link("man/figures/front/courses.png","https://www.crumplab.com/Courses.html", class = "hovericon")
```
...
```{r}
image_link("man/figures/front/apps.png","https://www.crumplab.com/Apps.html", class = "hovericon")
```
...
```{r}
image_link("man/figures/front/join.png","https://www.crumplab.com/Opportunities.html", class = "hovericon")
```
