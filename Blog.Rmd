...
1. When $t$ = 0, $p$ = 1. Obviously you do not have a 100% chance of getting a $t$ of 0 everytime under the null. Instead, you have a 100% chance of getting a $t$ that is 0 or larger (in absolute value) than 0.
...
If you used these decision regions, you would find $t$'s inside each band 5% of the time. The bands have different widths to accomodate the fact that $t$'s have different probabilities across the range. 
